...
export const WorkspacePreferencesModal = () => {
    ...
    const { ConfirmDialog, confirmation } = useConfirm({
        ...
        message: "This action cannot be undone. This will permanently delete this workspace and remove your data from our servers.",
    })

    const [renameValue, setRenameValue] = useState(workspace?.name);

    const { ConfirmDialog: UpdateDialog, confirmation: updateConfirmation } = useConfirm({
        title: "Are you sure you want to update this workspace?",
